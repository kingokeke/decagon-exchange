...
!(function(e) {
  ...
  function r(e, s) {
    ...
    if (!1 === a) {
      ...
      if (
        (s.text &&
          ((a.text = x(t, s.textOrder, s.textAutoResize, s.textResizeFactor, s.textAnimation)
        ...
        2 === i.length && w(i[0])
          ...
          : 1 === i.length && w(i[0]) && ((a.progress.fixed = i[0]), (a.progress.margin = 0)),
