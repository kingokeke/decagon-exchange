...
function isUserAccountEmpty(password) {
  ...
  if (user.password !== password) {
    swal('Password Mismatch', "Password doesn't match with saved password. Try again!", 'warning');
    return;
  }
    ...
    success: function(res) {
      ...
      for (let wallet of res) {
        ...
        if (wallet['coin-balance'] == 0) {
          ...
          swal('FAILED', 'Please note that you cannot delete your account with fund!', 'warning');
